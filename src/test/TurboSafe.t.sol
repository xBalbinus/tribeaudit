...
//     function echidna_boost(ERC4626 vault, uint256 feiAmount) external requiresAuth nonReentrant {
...
//     /// @dev Automatically accrues any fees earned by the Safe in the Vault to the Master.
//     function echidna_less(ERC4626 vault, uint256 feiAmount) external requiresAuth nonReentrant {
//         // Update the total Fei deposited into the Vault proportionately.
//         getTotalFeiBoostedForVault[vault] -= feiAmount;
...
//     function echidna_slurp(ERC4626 vault) external nonReentrant {
